...
for _e in range(epochs):
    ...
    with torch.no_grad():
        p = вычислите прогноз модели для x_val
        loss = вычислите потери для p и y_val
        Q_val = loss.item()
...
# переведите модель в режим эксплуатации
p = # вычислите прогноз модели по всем данным выборки X
Q = # вычислите потери с помощью loss_func для p и data_y; значение Q сохраните в виде вещественного числа
